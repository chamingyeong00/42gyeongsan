...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/19 16:09:26 by micha             #+#    #+#             */
/*   Updated: 2026/01/19 16:09:28 by micha            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void read_and_replace(char **argv, std::ifstream *inputFile, std::ofstream *outputFile)
{
	...
	std::string::size_type	end_last_found;
	...
	while(std::getline(*inputFile, line))
	{
		...
		if (to_find.empty()) 
		{
			std::cout << "find world emtpty" << std::endl;
			break;
		}
...
int main(int argc, char **argv)
{
	...
	if (argc != 4)
		return (std::cout << "Wrong number" << std::endl, 0);
